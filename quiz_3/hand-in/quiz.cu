                                 ...
                                 int ny)
{
  // Program kernel codes properly, otherwise your system could crash /* FIXME */
	...
	if ((ix < nx) && (iy < ny)) // As long as your code prevents access violation, you can modify this "if" condition.
	{
		MatC[idx] = MatA[idx] + MatB[idx]; // DO NOT change this code
	}
...
int main(int argc, char **argv)
{
    ...
    sumMatrixOnGPU<<<dim3{512, 512}, dim3{32, 32}>>>(d_MatA, d_MatB, d_MatC, nx, ny);
